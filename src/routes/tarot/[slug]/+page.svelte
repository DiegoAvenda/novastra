...
<main class="mx-5 sm:mx-16">
	<div class="sm:flex items-center sm:gap-10 mb-6">
		<div class="lg:w-2/4 flex flex-col sm:flex sm:flex-row-reverse gap-4">
			...
			<div class="flex justify-center gap-2 sm:flex-col">
